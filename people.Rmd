...
My research focuses on the intersection between traits, geographical distribution and historical and spatial diversification in flowering plants, and my long term goal is to understand the general rules that link these three components through flowering plant evolution. (first name pronunciation: "Tah-ees") <a href="ThaisVasconcelos_CV_Jan2023.pdf#" class="download" style="color:blue" title="Download CV as PDF">CV here</a>	 tvasc@umich.edu  | [Thais' GitHub](https://github.com/tncvasconcelos) | [Thais' Twitter](https://twitter.com/TNCVasconcelos) | [Thais' Google scholar](https://scholar.google.com/citations?user=bpkWIywAAAAJ&hl=en&oi=ao) 
