...
**Vasconcelos, T.**, & Boyko, J. D. (2024). mvh: An R tool to assemble and organize virtual herbaria from openly available specimen images. Applications in Plant Sciences, e11631.  
  
Nge, F. J., Hammer, T. A., **Vasconcelos, T.**, Biffin, E., Kellermann, J., & Waycott, M. (2024). Polyploidy linked with species richness but not diversification rates or niche breadth in Australian Pomaderreae (Rhamnaceae). Annals of Botany, mcae181.
